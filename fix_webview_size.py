            ...
            AndroidView(
                factory = { context ->
                    WebView(context).apply {
                        // Explicitly set Match Parent layout parameters to prevent 0x0 size in Compose
                        ...
                        webViewClient = object : WebViewClient() {
                            ...
                            override fun onPageFinished(view: WebView?, url: String?) {
                                ...
                                Log.d("SafeHerWebView", "Page loaded successfully: " + url)
                            }
                            ...
                            override fun onReceivedError(
                                ...
                                Log.e("SafeHerWebView", "Page load error: " + error?.description)
                            }
                        }
...
print("Updated MainActivity.kt successfully with ViewGroup layout settings and logging.")
